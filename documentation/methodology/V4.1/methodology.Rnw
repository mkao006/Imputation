...
<<wheat-production-area-explore, fig.width=15, fig.height=15, fig.cap='Wheat production and area harvested by country. The figure shows that excluding several producers such as India, Nepal, and Pakistan which has a stable trend in production, both the production and area of most countries display erratic behavior.', fig.pos='!ht'>>=
...
<<okra-production-area-explore, fig.width=15, fig.height=15, fig.cap='Even more so than both wheat and grape, the production of okra appears to demonstrate unpredictable trends and shocks.', fig.pos='!ht'>>=
