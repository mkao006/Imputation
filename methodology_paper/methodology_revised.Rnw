...
<<wheat-fit, fig.width=15, fig.height=10, fig.cap='Fitted value against observed value for yield of wheat'>>=
xyplot(valueYield + imputedYield ~ Year | FAOST_NAME,
       data = imputedWheat.dt,
       type = c("g", "l"), aspect = "fill", layout = c(15, 9),
       auto.key = TRUE, ylab = "Original and fitted yield")
@ 
...
<<linear-diagnostic-year-wheat, fig.width=15, fig.height=10, fig.cap='Standardized residual against fitted value for wheat with respect to year'>>=
...
<<linear-diagnostic-year-chickenmeat, fig.width=15, fig.height=10, fig.cap='Standardized residual against fitted value for chicken meat with respect to year'>>=
...
<<linear-diagonostric-country-wheat, fig.width=15, fig.height=10, fig.cap='Standardized residual against fitted value for wheat with respect to country'>>=
plot(imputedWheat.fit$model, resid(., type = "response", level = 1) ~
     fitted(., level = 1)|FAOST_NAME, pch = 16, cex = 0.5)

@ 

<<linear-diagonostric-country-chickenmeat, fig.width=15, fig.height=10, fig.cap='Standardized residual against fitted value for chicken meat with respect to country'>>=
plot(imputedChickenMeat.fit$model, 
...
<<normal-diagnostic-wheat, fig.width=15, fig.height=10, fig.cap='qqplot for each country for wheat'>>=
...
<<normal-diagnostic-chickenmeat, fig.width=15, fig.height=10, fig.cap='qqplot for each country for chicken meat'>>=
