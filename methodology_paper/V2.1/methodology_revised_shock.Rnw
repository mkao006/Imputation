...
the world from 1994 to 2011. Wheat is widely traded globally and
comercialised and data for wheat are relatively complete. Factors that
determines the production, area harvested and yield are well
understood. From table we can see that only 15\% of the production
require imputation.
