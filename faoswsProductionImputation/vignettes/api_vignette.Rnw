...
table(okrapd$productionFlag)
removeImputation(data = okrapd,
...
table(okrapd$areaHarvestedFlag)
removeImputation(data = okrapd,
...
bahrainExample = okrapd[areaName == "Bahrain", productionValue]
...
fijiExample = okrapd[areaName == "Fiji Islands", productionValue]
ensembleFit =
